...
@echo off
COLOR 0c
title DRAGONIC 2 Game Server Console
:start
echo Login Server.
echo.
...
java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5005 -server -Dfile.encoding=UTF-8 -Xmx4G -XX:+UseConcMarkSweepGC -XX:+UseTLAB -verbose:gc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -Xloggc:./gc.log -cp config;./../libs/* l2f.gameserver.GameServer
