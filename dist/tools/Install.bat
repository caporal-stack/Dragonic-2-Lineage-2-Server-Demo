@Echo off
COLOR 0C
TITLE Dragonic 2 Database Installer Console
cls
echo Welcome to script setup for Dragonic 2 Server.
...
echo * ####   #    #  #    #   ####    ####   #    #  #   ####    #####   *
echo **********************************************************************
echo Dragonic 2 Server is ready for installation.
...
set DB_USER=dragonic
set DB_PASSWORD=iJkgW0WRo0pQq9ov41UZgw8nVS3JCLQa4YOzjA4C93LYsiEWOqWYqwbSJmC5
set DB_NAME=dragonic2
:step2
...
echo #                    Visit us on : https://dragonic2.ddns.net/       #
echo ======================================================================
pause > nul