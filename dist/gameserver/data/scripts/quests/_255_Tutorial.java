...
// Tutorial close
		...
		else if (event.startsWith("CE"))
		{
			...
			if (event_id == 40)
			{
				...
				if (player.getLevel() >= 8 && player.getVarInt("lvl") < 8 && st.getInt("firstexp") == 1)
				{
				...
				// Synerge - Show a special tutorial htm for showing a npc in radar
				 if (player.getLevel() >= 32 && player.getVarInt("lvl") < 32)
				{
	...
	private static void checkClassMaster(QuestState st)
	{
		...
		if (canChangeClass(player, jobLevel))
		{
			...
			html.append("<html noscrollbar><head><title>Dragonic 2 World Newbie Tutorial</title></head>");
			html.append("<body>");
			...
			html.append("<font name=hs12 color=3399FF>Dragonic 2 World</font>");
			html.append("<img src=\"L2UI.squaregray\" width=285 height=1/>");
			html.append("</td></tr></table>");
			html.append("<br></td></tr><tr>");
			html.append("<td align=center height=150>");
			html.append("<table width=280><tr><td align=center><img src=\"LineageNPCsEspada.elixine\" width=256 height=140></td></tr>");
			html.append("<tr><td align=center><br><font color=LEVEL name=hs12>Welcome to Dragonic 2 World ! </font></td></tr>");
			html.append("</table>");
			html.append("<br1>");
