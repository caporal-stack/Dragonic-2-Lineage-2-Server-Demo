...
public class MergeCommunity implements ScriptFile, ICommunityBoardHandler
{
	...
	public static String getPathToMainHtm() {
		return PATH_TO_MAIN_HTM;
	}

	public static String getPathToEndingHtm() {
		return PATH_TO_ENDING_HTM;
	}

	public static String getStartedMergeVar() {
		return STARTED_MERGE_VAR;
	}

	public static String getAccountDataVar() {
		return ACCOUNT_DATA_VAR;
	}

	public static String getCharNameDataVar() {
		return CHAR_NAME_DATA_VAR;
	}

	public static String getClanNameDataVar() {
		return CLAN_NAME_DATA_VAR;
	}
}
