...
{
	// Đ­Ń‚Đ¸ ĐżĐµŃ€ĐµĐĽĐµĐ˝Đ˝Ń‹Đµ Đ˛Ń‹Ń�Ń‚Đ°Đ˛Đ»ŃŹŃŽŃ‚Ń�ŃŹ Đ°Đ˛Ń‚ĐľĐĽĐ°Ń‚Đ¸Ń‡ĐµŃ�ĐşĐ¸ ĐżŃ€Đ¸ Đ˛Ń‹Đ·ĐľĐ˛Đµ Ń�ĐşŃ€Đ¸ĐżŃ‚Đ°
	...
	public void template_check1(Player player, String[] var)
	{
		...
		say(player.getName() + " created a battle " + _team1count + "Ń…" + _team2count + ", " + _team1min + "-" + _team1max + "lv vs " + _team2min + "-" + _team2max + "lv, rate " + _price + "Đ°, Start over " + _timeToStart + " min");
	...
	public void template_check2(Player player, String[] var)
	{
		...
		_team2live.clear();
		_team1list.add(player.getStoredId());
		say(player.getName() + " created a battle " + _team1count + "Ń…" + _team2count + ", " + _team1min + "-" + _team1max + "lv vs " + _team2min + "-" + _team2max + "lv, rate " + "experience, beginning in " + _timeToStart + " min");
		executeTask("events.arena." + _className, "announce", new Object[0], 60000);*/
	}
	...
	public void template_announce()
	{
		...
		{
			_timeToStart--;
			say(creator.getName() + " created a battle " + _team1count + "Ń…" + _team2count + ", " + _team1min + "-" + _team1max + "lv vs " + _team2min + "-" + _team2max + "lv, rate " + (_battleType == 1 ? _price + "Đ°" : "experience") + ", Start over " + _timeToStart + " min");
			executeTask("events.arena." + _className, "announce", new Object[0], 60000);
		}
	...
	public class ZoneListener implements OnZoneEnterLeaveListener
	{
		...
		public void onZoneLeave(Zone zone, Creature cha)
		{
			...
			if (_status >= 2 && player != null && (_team1list.contains(player.getStoredId()) || _team2list.contains(player.getStoredId())))
			{
				double angle = PositionUtils.convertHeadingToDegree(cha.getHeading()); // Ń�ĐłĐľĐ» Đ˛ ĐłŃ€Đ°Đ´Ń�Ń�Đ°Ń…
				double radian = Math.toRadians(angle - 90); // Ń�ĐłĐľĐ» Đ˛ Ń€Đ°Đ´Đ¸Đ°Đ˝Đ°Ń…
