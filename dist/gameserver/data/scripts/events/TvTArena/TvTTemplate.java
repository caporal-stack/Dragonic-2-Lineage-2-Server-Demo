...
public abstract class TvTTemplate extends Functions
{
	...
	public void template_check1(Player player, NpcInstance manager, String[] var)
	{
		...
		sayToAll(player.getName() + " created a battle " + _team1count + "Ń…" + _team2count + ", " + _team1min + "-" + _team1max + "lv vs " + _team2min + "-" + _team2max + "lv, rate " + _price + " " + ITEM_NAME + ", Start over " + _timeToStart + " min");
	...
	public void template_announce()
	{
		...
		{
			_timeToStart--;
			sayToAll(creator.getName() + " created a battle " + _team1count + "Ń…" + _team2count + ", " + _team1min + "-" + _team1max + "lv vs " + _team2min + "-" + _team2max + "lv, rate " + _price + " " + ITEM_NAME + ", Start over " + _timeToStart + " min");
			executeTask("events.TvTArena." + _className, "announce", new Object[0], 60000);
		}
