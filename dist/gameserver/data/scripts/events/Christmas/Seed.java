...
public class Seed extends ScriptItemHandler implements ScriptFile
{
	...
	public boolean useItem(Playable playable, ItemInstance item, boolean ctrl)
	{
		...
		npc.setTitle(activeChar.getName()); //FIXME ĐźĐľŃ‡ĐµĐĽŃ�-Ń‚Đľ Đ˝Đµ Ń�Ń�Ń‚Đ°Đ˝Đ°Đ˛Đ»Đ¸Đ˛Đ°ĐµŃ‚Ń�ŃŹ
		spawn.respawnNpc(npc);

		// Đ�Đ� Đ˛ĐµŃ‰Đ°ŃŽŃ‰ĐµĐµ Đ±Đ°Ń„Ń„ Ń€ĐµĐłĐµĐ˝Đ° Ń�Ń�Ń‚Đ°Đ˝Đ°Đ˛Đ»Đ¸Đ˛Đ°ĐµŃ‚Ń�ŃŹ Ń‚ĐľĐ»ŃŚĐşĐľ Đ´Đ»ŃŹ Đ±ĐľĐ»ŃŚŃ�ĐľĐą ĐµĐ»ĐşĐ¸
		if (itemId == 5560)
